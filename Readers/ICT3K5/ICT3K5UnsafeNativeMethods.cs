...
namespace Filuet.Hardware.CardReaders.Readers.ICT3K5
{
    ...
    internal class ICT3K5UnsafeNativeMethods
    {
        ...
        internal static extern ICT3K5ErrorCode ExecuteCommand(string serial, [MarshalAs(UnmanagedType.Struct)] ICT3K5Command command, int timeout, [MarshalAs(UnmanagedType.Struct)] ref ICT3K5Response reply);
        ...
        [DllImport("C:\\Filuet\\Filuet.Pos.Agent\\ICT3K5_6290DLL.dll", CharSet = CharSet.None, BestFitMapping = false, ThrowOnUnmappableChar = true)]
        internal static extern ICT3K5ErrorCode ExecuteCommand(string serial, [MarshalAs(UnmanagedType.Struct)] IST3K5InitCommand cmd, int timeout, [MarshalAs(UnmanagedType.Struct)] ref ICT3K5Response reply);
